package neteland.iselin.calculator.data

import android.support.annotation.VisibleForTesting
import io.reactivex.Flowable
import neteland.iselin.calculator.data.datamodel.ExpressionDataModel
import neteland.iselin.calculator.data.datamodel.OperandDataModel
import neteland.iselin.calculator.data.datamodel.OperatorDataModel
...
object CalculatorImpl : ICalculator {
    ...
    private fun evaluate(expression: String): Flowable<ExpressionDataModel> {
        ...
        //get ops and ops
        val operatorDataModels: MutableList<OperatorDataModel> =
            getOperators(expression)
        val operands: MutableList<OperandDataModel> =
